...
export function uniqueNonEmptyStrings(values: Array<string | undefined>): string[] {
  const seen = new Set<string>();
  const result: string[] = [];
...
export function normalizeWebSearchToolAttachment(source: Partial<ChatToolAttachment>): ChatWebSearchToolAttachment | undefined {
...
export function normalizeNetworkToolAttachment(source: Partial<ChatToolAttachment>): ChatNetworkToolAttachment | undefined {
...
export function shouldPreserveNetworkAttachmentRaw(attachment: ChatNetworkToolAttachment): boolean {
  return attachment.fullAccess === true && attachment.redacted === false;
}

export function redactNetworkAttachmentRequestsForSharedText(
...
export function isFullAccessNetworkAttachmentSource(source: Partial<ChatToolAttachment>): source is Partial<ChatNetworkToolAttachment> {
  return "fullAccess" in source && source.fullAccess === true && source.redacted === false;
}

export function normalizeJsSourceToolAttachment(source: Partial<ChatToolAttachment>): ChatJsSourceToolAttachment | undefined {
...
export function normalizeSourceMapToolAttachment(source: Partial<ChatToolAttachment>): ChatSourceMapToolAttachment | undefined {
...
export function normalizeBrowserScreenshotToolAttachment(source: Partial<ChatToolAttachment>): ChatBrowserScreenshotToolAttachment | undefined {
...
export function normalizeAutomationReportToolAttachment(source: Partial<ChatToolAttachment>): ChatAutomationReportToolAttachment | undefined {
...
export function normalizeGenericToolAttachment(source: Partial<ChatToolAttachment>, kind: string): ChatGenericToolAttachment | undefined {
...
export function estimatePngDataUrlBytes(dataUrl: string | undefined): number {
...
export function normalizeScreenshotClip(value: unknown): ChatBrowserScreenshotToolAttachment["clip"] | undefined {
...
export function formatBrowserScreenshotAttachmentSummary(attachment: ChatBrowserScreenshotToolAttachment): string {
...
export function formatAttachmentByteSize(value: number): string {
  if (value < 1024) {
    return `${value} B`;
  }
  const kb = value / 1024;
...
export function normalizeJsSourceResource(value: unknown): JsSourceResource | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function normalizeJsSourceMatch(value: unknown): JsSourceMatch | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function normalizeJsSourceContext(value: unknown): JsSourceContext | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function normalizeJsSourceFetchFailure(value: unknown): JsSourceFetchFailure | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function formatJsSourceAttachmentForText(attachment: ChatJsSourceToolAttachment): string {
...
export function formatAutomationReportAttachmentForText(attachment: ChatAutomationReportToolAttachment): string {
  const lines = [
...
export function formatSourceMapAttachmentForText(attachment: ChatSourceMapToolAttachment): string {
  const sections: string[] = [];
...
export function formatSourceMapCandidateLocation(candidate: SourceMapCandidate): string {
  if (candidate.inline) {
    return "inline";
  }
...
export function normalizeSourceMapCandidate(value: unknown): SourceMapCandidate | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function normalizeSourceMapResolvedLocation(value: unknown): SourceMapResolvedLocation | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function normalizeSourceMapOriginalContext(value: unknown): SourceMapOriginalContext | undefined {
...
export function normalizeSourceMapFailure(value: unknown): ChatSourceMapToolAttachment["failures"][number] | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function normalizeAutomationReportStep(value: unknown): AutomationReportStep | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function normalizeAutomationTimeline(value: unknown, steps: AutomationReportStep[]): AutomationTimelineEvent[] {
...
export function normalizeAutomationTimelineEvent(value: unknown): AutomationTimelineEvent | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function createAutomationReportStep(record: ChatToolCallRecord, attachments: ChatToolAttachment[]): AutomationReportStep {
...
export function createAutomationTimeline(records: ChatToolCallRecord[], steps: AutomationReportStep[]): AutomationTimelineEvent[] {
...
export function createAutomationTimelineFromSteps(steps: AutomationReportStep[]): AutomationTimelineEvent[] {
...
export function getAutomationTimelineEventType(record: ChatToolCallRecord): AutomationTimelineEvent["type"] {
...
export function getAutomationTimelineEventTypeFromStep(step: AutomationReportStep): AutomationTimelineEvent["type"] {
...
export function inferAutomationReportType(records: ChatToolCallRecord[]): AutomationReportType {
...
export function normalizeAutomationReportType(value: unknown, steps: AutomationReportStep[]): AutomationReportType {
  return isAutomationReportType(value) ? value : inferAutomationReportTypeFromSteps(steps);
}

export function aggregateAutomationReportType(attachments: ChatAutomationReportToolAttachment[]): AutomationReportType {
...
export function inferAutomationReportTypeFromSteps(steps: AutomationReportStep[]): AutomationReportType {
...
export function normalizeAutomationFailureSummary(value: unknown, steps: AutomationReportStep[]): AutomationFailureSummary | undefined {
...
export function normalizeAutomationReportPlaybook(value: unknown): AutomationPlaybookSelection | undefined {
  if (!value || typeof value !== "object") {
    return undefined;
  }
...
export function createAutomationFailureSummary(steps: AutomationReportStep[]): AutomationFailureSummary | undefined {
...
export function redactAndTruncateAutomationText(value: unknown, maxLength: number): string {
...
export function redactInlineSensitiveText(value: string): string {
  return redactNetworkInlineSensitiveText(value);
}

export function redactAutomationText(value: string): string {
...
export function redactGenericToolText(value: string): string {
  return redactAutomationText(value);
}

export function isPlainFormEncodedText(value: string): boolean {
  return /^[^=\s]+=[^=\s]+(?:&[^=\s]+=[^=\s]+)*$/.test(value);
}

export function isToolCallStatus(value: unknown): value is AutomationReportStep["status"] {
  return value === "running" || value === "success" || value === "error";
}

export function isAutomationTimelineEventType(value: unknown): value is AutomationTimelineEvent["type"] {
  return value === "tool_call" || value === "page_change" || value === "wait" || value === "user_confirmation" || value === "failure_recovery";
}

export function isAutomationReportType(value: unknown): value is AutomationReportType {
  return value === "general" || value === "page_inspection" || value === "form_diagnosis" || value === "interface_analysis";
}

export function isSourceMapCandidateSource(value: unknown): value is SourceMapCandidate["source"] {
  return value === "response-header" || value === "x-source-map-header" || value === "source-mapping-url" || value === "inline";
}

export function isSourceMapCandidateStatus(value: unknown): value is SourceMapCandidate["status"] {
